...
describe("createUseHookCallIndex", () => {
  it("will properly increment numbers across a single component and maintain across rerenders", () => {
    ...
    const Component: TestingComponent & jest.Mock = jest.fn(
      ({ hookResultsRef }) => {
  ...
  it("will not modify the value across remounts", () => {
    ...
    const { rerender } = render(
      <Component hookResultsRef={hookResultsRef} key={(key++).toString()} />,
    );
  ...
  it("can maintain multiple increments within the same component", () => {
    ...
    const Component = ({
      ...
      hookResultsRef1: HookResultsRef;
      hookResultsRef2: HookResultsRef;
    }) => {
    ...
    render(
      <Component
        hookResultsRef1={hookResultsRef1}
        hookResultsRef2={hookResultsRef2}
      />,
    );
